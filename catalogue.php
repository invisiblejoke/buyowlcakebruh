...
<body id="top" data-spy="scroll">
        ...
        <div class="container">
            ...
            <div class="text-center"><h3>Shopping Cart</h3> <a id="btnEmpty" href="catalogue.php?action=empty">Empty Cart</a></div>
               ...
               <!-- <button type="submit" name="filter-cookie" id="filter-cookie" value="cookie">Cookie</button>-->
       ...
       $(document).ready(function(){
            $('#myProdModal').on('show.bs.modal', function (e) {
                ...
                $.ajax({
                    type : 'POST',
                    url : 'productdetail.php?', //Here you will fetch records  
                    cache:false,
                    data:{'val': rowid}, 
                    async:true,        
          ...
          /*  $('#filter-cookie').click(function(){
                var passfilter = document.getElementById('filter-cookie').value;
                $.ajax({
                    type: 'POST',
                    url: 'storefilter.php',
                    cache: false,
                    data: {'testdata': passfilter},
                    success : function(data){
