            ...
            <div class="col-md-6 col-md-offset-3">
                <div class="panel panel-login">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <table id="clients-table" class="table"  data-toggle="table" data-sort-name="CollectDate" >
                                    <thead>
										<tr id="table">
									    	<th data-field="Date" data-sortable="true">Order Date</th>
									    	<th data-field="Order" data-sortable="true">Cake name</th>
									    	<th data-field="Quantity" data-sortable="true">Quantity</th>
									    	<th data-field="CollectDate" data-sortable="true">Collection Date</th>
									  	</tr>
									</thead>
