        ...
        <div class="container">  
            ...
            <table class="table table-striped custab"> 
                ...
                ?>  
                        ...
                        <input type="hidden" name="return" value="http://127.0.0.1/buyowlcakebruh/checkout2.php">
                        <input type="hidden" name="cancel_return" value="http://127.0.0.1/buyowlcakebruh/paymentFail.php">
                ...
                <tr>
                    <td colspan="5">
                        <div class="form-group text-right">
                            ...
                            <input type="submit" formaction="https://www.sandbox.paypal.com/cgi-bin/webscr" name="paypal-submit" id="paypal-submit" tabindex="4" class="form-control btn btn-primary" value="PayPal">       
                        </div>
                    </td>
               </tr>
               <tr>
